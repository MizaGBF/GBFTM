            ...
            match s:
                case "0":
                    try:
                        ...
                        u = "https://prd-game-a-granbluefantasy.akamaized.net/assets_en/img/sp/assets/item/article/m/{}.jpg".format(s)
                    except:
                        print("Invalid ID")
                        continue
                case "1":
                    try:
                        ...
                        while True:
                            ...
                            p = input()
                            if p in ["0", "1"]: break
                        u = "https://prd-game-a1-granbluefantasy.akamaized.net/assets_en/img/sp/quest/assets/free/conquest_{}_proud{}.png".format(str(s).zfill(3), ("plus" if p == "1" else ""))
                    except:
                        print("Invalid ID")
                        continue
                case "2":
